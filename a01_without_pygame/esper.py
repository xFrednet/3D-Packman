...
class World:
    ...
    def add_resource(self, resource_instance: _Any) -> None:
        """Add a resource instance to the World.

        :param resource_instance: A resource that can be accessed by all processors 
        """
        self._resource[type(resource_instance)] = resource_instance

    def remove_resource(self, resource_type: _Any) -> None:
        """Remove a Resource from the World, by type.

        :param resource_type: The class type of the resource to remove.
        """

        self._resource[resource_type] = None

    def get_resource(self, resource_type: _Type[P]) -> P:
        """Get a resource instance, by type.

        :param resource_type: The type of the resource you wish to retrieve.
        :return: A resource instance that has previously been added to the World.
        """
